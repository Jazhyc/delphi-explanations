...
class RunConfig(Serializable):
    ...
    shared_explanations_path: str | None = field(
        default=None,
    )
    """Path to shared explanations directory. If specified, explanations will be saved to
    and loaded from this directory instead of experiment-specific paths (results/{name}/explanations/).
    This allows multiple experiments with different scorers to reuse the same explanations
    generated by a fixed explainer model, saving computation time. Path can be relative or absolute."""
